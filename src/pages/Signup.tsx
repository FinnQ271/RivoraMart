    ...
    <div className="mt-4">
      ...
      <form>
        <div className="form-group position-relative mb-4">
          <input type="text" id="input-email" className="form-control py-2" placeholder="Email" required autoComplete="off" />
        </div>
        <div className="form-group position-relative mb-4">
          <input type="password" className="form-control input-password py-2" placeholder="Password" required />
        ...
        <div className="form-group position-relative mb-3">
          <input type="password" className="form-control input-password py-2" placeholder="Confirm password" required />
          <div className="toggle-password">
            <svg viewBox="0 0 24 24" width={24} height={24} stroke="currentColor" strokeWidth={2} fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24" />
              <line x1={1} y1={1} x2={23} y2={23} />
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          <a className="text-primary" href="#">privacy policies</a>
        </div>
        <button className="btn btn-primary btn-block font-weight-bold custom-btn-p mt-3" type="submit">
          Create Account
        </button>
      </form>
