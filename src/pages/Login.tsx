    ...
    <div className="mt-4">
      ...
      <form>
        ...
        <div className="text-end">
          <button className="btn btn-primary btn-block font-weight-bold px-4" type="submit">
            Login
          </button>
        </div>
      </form>
      ...
      <p className="mt-4 text-center">
        ...
        <a className="text-primary" href="signup.html">Sign Up</a>
      </p>
      <p className="mt-4 text-center">
        Did you forget your password?
        <a className="text-primary" href="forgot-password.html">Recover Password</a>
      </p>
    </div>
  </section>
</div>
